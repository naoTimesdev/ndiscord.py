...
This is a list of Frequently Asked Questions regarding using ``ndiscord.py`` and its extension modules. Feel free to suggest a
...
Example code can be found in the `examples folder <https://github.com/naoTimesdev/ndiscord.py/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/naoTimesdev/ndiscord.py/blob/master/examples/background_task.py>`_
